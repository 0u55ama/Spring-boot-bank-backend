...
public class BankStatement {
     ...
     * generating a pdf file of a transactions
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate)
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("Backend Bank App"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(20f);
        PdfPCell bankAddress = new PdfPCell(new Phrase("00 Imaginary 101 Address"));
        ...
        PdfPCell from = new PdfPCell(new Phrase("Start Date: " + startDate));
        from.setBorder(0);
        PdfPCell statement = new PdfPCell(new Phrase("STATEMENT OF ACCOUNT"));
        statement.setBorder(0);
        PdfPCell to = new PdfPCell(new Phrase("End Date :" + endDate));
        to.setBorder(0);
        ...
        statementInfo.addCell(from);
        statementInfo.addCell(statement);
        statementInfo.addCell(to);
